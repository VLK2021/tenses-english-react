export const vocabularyForIt = [
    {
        id: 'VFI1',
        infinitive: 'adware',
        transcriptionInf: '[ˈædˌwɛər]',
        translation: 'рекламне/програмне забезпечення',
        incorrect_answers: [
            "brave",
            "calm",
            "charming"
    ...
    },
    {
        ...
        transcriptionInf: '[ˌæplɪˈkeɪʃən]',
        translation: 'застосування/програма',
        incorrect_answers: [
            "slowly",
            "suddenly",
            "sincere"
    ...
    {
        id: 'VFI4',
        infinitive: 'available',
        transcriptionInf: '[əˈveɪləbl]',
    ...
    },
    {
        id: 'VFI5',
        infinitive: 'account',
        transcriptionInf: '[əˈkaʊnt]',
        translation: 'рахунок/аккаунт',
        incorrect_answers: [
            "gently",
            "calmly",
            "firmly"
    ...
    {
        id: 'VFI6',
        infinitive: 'abbreviation',
        transcriptionInf: '[əˌbriːviˈeɪʃən]',
        translation: 'скорочення/абревіатура',
        incorrect_answers: [
            "honest",
            "generous",
            "charming"
    ...
    },
    {
        id: 'VFI8',
        infinitive: 'backup',
        transcriptionInf: '[ˈbækʌp]',
        translation: 'резервне копіювання',
        incorrect_answers: [
            "optimistic",
            "talented",
            "happy"
    ...
    {
        id: 'VFI56',
        infinitive: 'microservices',
        transcriptionInf: '[ˈmaɪkrəʊˌsɜːrvɪsɪz]',
        translation: 'мікросервіси',
        incorrect_answers: [
            "approve",
            "connect",
            "testing"
    ...
    },
    {
        id: 'VFI60',
        infinitive: 'reboot',
        transcriptionInf: '[riːˈbuːt]',
        translation: 'перезавантаження',
        incorrect_answers: [
            "library",
            "property",
            "disconnect"
    ...
    {
        id: 'VFI61',
        infinitive: 'credentials',
        transcriptionInf: '[krɪˈdɛnʃəlz]',
        translation: 'облікові дані',
        incorrect_answers: [
            "brave",
            "calm",
            "charming"
